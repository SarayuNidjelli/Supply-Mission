...
function setup() {
	...
	groundSprite=createSprite(400, 650, 600,10);
	...
	ground = Bodies.rectangle(400, 650, 800, 10 , {isStatic:true} );
 	...
 	boxLeftBody = Bodies.rectangle(320, 600, 20,100 , {isStatic:true} );
 	...
 	boxBottomBody = Bodies.rectangle(400, 625, 200,20 , {isStatic:true} );
 	World.add(world, boxBottomBody);



 	boxleftSprite=createSprite(500 , 600, 20,100);
 	boxleftSprite.shapeColor=color(255,0,0);

 	boxRightBody = Bodies.rectangle(480 , 600, 20,100 , {isStatic:true} );
